...
module towngame {
    export class ScenesManager {
        ...
        private static loop() {
            ...
            ScenesManager._applyRatio(ScenesManager.currentScene, ScenesManager.ratio); //scale to screen size
            ...
            ScenesManager._applyRatio(ScenesManager.currentScene, 1/ScenesManager.ratio); //restore original scale

        }

        public static createScene(id:string, TScene:typeof Scene):Scene {
